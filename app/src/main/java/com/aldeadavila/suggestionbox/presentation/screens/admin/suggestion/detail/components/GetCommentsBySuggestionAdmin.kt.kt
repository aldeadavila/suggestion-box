...
import com.aldeadavila.suggestionbox.presentation.screens.client.suggestion.detail.components.ClientCommentListBySuggestionContent

@Composable
fun GetCommentsBySuggestionAdmin(
    ...
    when (val response = vm.commentsResponse) {
        ...
        is Resource.Succes -> {
            AdminCommentListBySuggestionContent(
                navHostController,
                paddingValues = paddingValues,
