...
import com.aldeadavila.suggestionbox.ui.screens.admin.category.update.mapper.toCategory
import com.aldeadavila.suggestionbox.ui.util.ComposeFileProvider
import com.aldeadavila.suggestionbox.ui.util.ResultingActivityHandler
...
class AdminCategoryUpdateViewModel @Inject constructor(
    ...
    fun updateCategoryWithImage() = viewModelScope.launch {
        ...
        val result = categoriesUseCase.updateCategoryWithImage(
            category.id ?: "",
            state.toCategory(),
            file!!
        )
    ...
    fun updateCategory() = viewModelScope.launch {
        ...
        categoryResponse = Resource.Loading
        val result = categoriesUseCase.updateCategory(
            category.id ?: "",
            state.toCategory()
        )
        categoryResponse = result
